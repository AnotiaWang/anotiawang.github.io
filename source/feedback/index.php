...
<body>
  ...
  <div class="collapse navbar-collapse" id="navmenu">
    <ul class="navbar-nav mr-auto nav">	 
      <li class="nav-item">
        <a class="nav-link" href="https://blog.anotia.top/chat">Tia Chat 聊天室</a>
      </li>
      <li class="nav-item">
...
?>      
  ...
  ?>
   ...
   <!-- </div>-->  
<footer class="p-5 text-center"><?php echo $config['title'];?> - Powered by <a href="https://7alk.com/" target="_blank">7alk</a> Talk <?php echo $config['ver'];?>   <br> <a href="https://blog.anotia.top/chat"> Tia Chat </a> <br>「加载用时 <?php $t2 = microtime(true); echo round($t2-$t1,3); ?>s」</footer>   
<!--对话框-->
<!-- 模态框 -->
